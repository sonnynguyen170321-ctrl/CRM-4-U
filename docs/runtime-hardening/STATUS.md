...
**Next unchecked task:** `P1.3` — OutboundMessage model: server-derived idempotencyKey @unique.
**Blockers:** none.
...
- 2026-06-23 — **P1.2** ✓ — Dynamic creation and status/progress tracking of JobRun model in database integrated into the enqueuer and base worker.
